#!/usr/bin/env python3
"""
PC操作支援アプリケーション - 自動スクリーンショット版実行スクリプト
"""

import os
import sys
import signal
from main_controller_auto_screenshot import MainControllerAutoScreenshot
...
def print_usage_instructions():
    ...
    print()
    print("=" * 70)
    print("🤖 PC操作支援アプリケーション（自動スクリーンショット版）")
    print("=" * 70)
    print()
    print("🆕 新機能: 質問時に自動でスクリーンショット撮影")
    print()
    print("📋 使用方法:")
    print("  1. ❓ 質問入力")
    print("     - テキストボックスに質問を入力して「🚀 質問する」ボタンをクリック")
    print("     - 自動的にスクリーンショットが撮影されます")
    print("     - または 🎤 音声入力ボタン（利用可能な場合）")
    print()
    print("  2. 📷 手動スクリーンショット（必要に応じて）")
    print("     - 「📷 手動スクリーンショット」ボタンをクリック")
    ...
    print()
    print("⚙️ 設定:")
    print("  - 🔄 自動スクリーンショット機能のON/OFF切り替え可能")
    print("  - チェックボックスで簡単に切り替えできます")
    print()
    print("💡 質問例:")
...
def main():
    ...
    try:
        print()
        print("🚀 自動スクリーンショット版アプリケーションを起動中...")
        ...
        print("💡 質問を入力すると自動的にスクリーンショットが撮影されます")
